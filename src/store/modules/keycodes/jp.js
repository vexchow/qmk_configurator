export default [
  { label: 'JP', width: 'label', group: true },
  ...
  { name: '~', code: 'JP_TILD', keys: '`' },
  { name: '!', code: 'JP_EXLM', keys: '!' },
  { name: '@', code: 'JP_AT', keys: '@' },
  { name: '#', code: 'JP_HASH', keys: '#' },
  { name: '$', code: 'JP_DLR', keys: '$' },
  { name: '%', code: 'JP_PERC', keys: '%' },
  { name: '^', code: 'JP_CIRC', keys: '^' },
  { name: '&', code: 'JP_AMPR', keys: '&' },
  { name: '*', code: 'JP_ASTR', keys: '*' },
  { name: '(', code: 'JP_LPRN', keys: '(' },
  { name: ')', code: 'JP_RPRN', keys: ')' },
  { name: '_', code: 'JP_UNDS', keys: '_' },
  { name: '+', code: 'JP_PLUS', keys: '+' },
  { name: '{', code: 'JP_LCBR', keys: '{' },
  { name: '}', code: 'JP_RCBR', keys: '}' },
  { name: '<', code: 'JP_LT', keys: '<' },
  { name: '>', code: 'JP_GT', keys: '>' },
  { name: ':', code: 'JP_COLN', keys: ':' },
  { name: '|', code: 'JP_PIPE', keys: '|' },
  { name: '?', code: 'JP_QUES', keys: '?' },
  { name: '"', code: 'JP_DQUO', keys: '"' }
];
